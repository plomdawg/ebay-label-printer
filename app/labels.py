...
class LabelManager:
    ...
    def buy_shipping_label(self, order_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """
        ...
        logger.info(f"Buying shipping label for order {order_data.get('order_id', 'unknown')}")
    ...
    def download_label_pdf(self, label_url: str, order_id: str) -> Optional[Path]:
        ...
        logger.info(f"Downloading label PDF for order {order_id}")
